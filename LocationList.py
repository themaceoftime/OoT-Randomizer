...
location_table = OrderedDict([
    ...
    ("SFM Deku Scrub Grotto Rear",                                   ("GrottoNPC",    0xEE,  0x39, None,                        'Buy Red Potion for 30',                   ("Sacred Forest Meadow", "Forest", "Deku Scrub", "Grottos"))),
    ...
    ("Market Bazaar Item 2",                                         ("Shop",         0x2C,  0x31, (shop_address(4, 1), None),  'Buy Bombs (5) for 35',                    ("the Market", "Market", "Shops"))),
    ...
    ("Market Potion Shop Item 3",                                    ("Shop",         0x31,  0x32, (shop_address(3, 2), None),  'Buy Red Potion for 30',                   ("the Market", "Market", "Shops"))),
    ...
    ("LLR Deku Scrub Grotto Right",                                  ("GrottoNPC",    0xFC,  0x37, None,                        'Buy Bombs (5) for 35',                    ("Lon Lon Ranch", "Deku Scrub", "Grottos"))),
    ...
    ("Kak Bazaar Item 2",                                            ("Shop",         0x2C,  0x39, (shop_address(5, 1), None),  'Buy Bombs (5) for 35',                    ("Kakariko Village", "Kakariko", "Shops"))),
    ...
    ("Kak Potion Shop Item 3",                                       ("Shop",         0x30,  0x32, (shop_address(1, 2), None),  'Buy Red Potion for 30',                   ("Kakariko Village", "Kakariko", "Shops"))),
    ...
    ("GC Deku Scrub Grotto Right",                                   ("GrottoNPC",    0xFB,  0x37, None,                        'Buy Bombs (5) for 35',                    ("Goron City", "Deku Scrub", "Grottos"))),
    ...
    ("GC Shop Item 1",                                               ("Shop",         0x2E,  0x30, (shop_address(8, 0), None),  'Buy Bombs (5) for 25',                    ("Goron City", "Shops",))),
    ...
    ("GC Shop Item 7",                                               ("Shop",         0x2E,  0x36, (shop_address(8, 6), None),  'Buy Red Potion for 40',                   ("Goron City", "Shops",))),
    ...
    ("DMC Deku Scrub",                                               ("NPC",          0x61,  0x37, None,                        'Buy Bombs (5) for 35',                    ("Death Mountain Crater", "Death Mountain", "Deku Scrub"))),
    ...
    ("DMC Deku Scrub Grotto Right",                                  ("GrottoNPC",    0xF9,  0x37, None,                        'Buy Bombs (5) for 35',                    ("Death Mountain Crater", "Death Mountain", "Deku Scrub", "Grottos"))),
    ...
    ("ZR Deku Scrub Grotto Rear",                                    ("GrottoNPC",    0xEB,  0x39, None,                        'Buy Red Potion for 30',                   ("Zora's River", "Deku Scrub", "Grottos"))),
    ...
    ("ZD Shop Item 8",                                               ("Shop",         0x2F,  0x37, (shop_address(7, 7), None),  'Buy Red Potion for 50',                   ("Zora's Domain", "Shops",))),
    ...
    ("LH Deku Scrub Grotto Right",                                   ("GrottoNPC",    0xEF,  0x37, None,                        'Buy Bombs (5) for 35',                    ("Lake Hylia", "Deku Scrub", "Grottos"))),
    ...
    ("GV Deku Scrub Grotto Rear",                                    ("GrottoNPC",    0xF0,  0x39, None,                        'Buy Red Potion for 30',                   ("Gerudo Valley", "Gerudo", "Deku Scrub", "Grottos"))),
    ...
    ("Colossus Deku Scrub Grotto Rear",                              ("GrottoNPC",    0xFD,  0x39, None,                        'Buy Red Potion for 30',                   ("Desert Colossus", "Deku Scrub", "Grottos"))),
    ...
    ("Dodongos Cavern MQ Deku Scrub Side Room Near Lower Lizalfos",  ("NPC",          0x01,  0x39, None,                        'Buy Red Potion for 30',                   ("Dodongo's Cavern", "Master Quest", "Deku Scrub",))),
    ...
    ("Ganons Castle Deku Scrub Center-Left",                         ("NPC",          0x0D,  0x37, None,                        'Buy Bombs (5) for 35',                    ("Ganon's Castle", "Vanilla", "Deku Scrub",))),
    ("Ganons Castle Deku Scrub Center-Right",                        ("NPC",          0x0D,  0x33, None,                        'Buy Arrows (30)',                       ("Ganon's Castle", "Vanilla", "Deku Scrub",))),
    ("Ganons Castle Deku Scrub Right",                               ("NPC",          0x0D,  0x39, None,                        'Buy Red Potion for 30',                   ("Ganon's Castle", "Vanilla", "Deku Scrub",))),
    # Ganon's Castle MQ
    ...
    ("Ganons Castle MQ Deku Scrub Center-Left",                      ("NPC",          0x0D,  0x37, None,                        'Buy Bombs (5) for 35',                    ("Ganon's Castle", "Master Quest", "Deku Scrub",))),
    ("Ganons Castle MQ Deku Scrub Center",                           ("NPC",          0x0D,  0x33, None,                        'Buy Arrows (30)',                       ("Ganon's Castle", "Master Quest", "Deku Scrub",))),
    ("Ganons Castle MQ Deku Scrub Center-Right",                     ("NPC",          0x0D,  0x39, None,                        'Buy Red Potion for 30',                   ("Ganon's Castle", "Master Quest", "Deku Scrub",))),
