...
location_table = OrderedDict([
    ...
    ("SFM Deku Scrub Grotto Rear",                                   ("GrottoNPC",    0xEE,  0x39, None,                        'Buy Red Potion for 30 Rupees',          ("Sacred Forest Meadow", "Forest", "Deku Scrub", "Grottos"))),
    ...
    ("LLR Deku Scrub Grotto Right",                                  ("GrottoNPC",    0xFC,  0x37, None,                        'Buy Bombs (5) for 35 Rupees',           ("Lon Lon Ranch", "Deku Scrub", "Grottos"))),
    ...
    ("GC Deku Scrub Grotto Right",                                   ("GrottoNPC",    0xFB,  0x37, None,                        'Buy Bombs (5) for 35 Rupees',           ("Goron City", "Deku Scrub", "Grottos"))),
    ...
    ("DMC Deku Scrub",                                               ("NPC",          0x61,  0x37, None,                        'Buy Bombs (5) for 35 Rupees',           ("Death Mountain Crater", "Death Mountain", "Deku Scrub"))),
    ...
    ("DMC Deku Scrub Grotto Right",                                  ("GrottoNPC",    0xF9,  0x37, None,                        'Buy Bombs (5) for 35 Rupees',           ("Death Mountain Crater", "Death Mountain", "Deku Scrub", "Grottos"))),
    ...
    ("ZR Deku Scrub Grotto Rear",                                    ("GrottoNPC",    0xEB,  0x39, None,                        'Buy Red Potion for 30 Rupees',          ("Zora's River", "Deku Scrub", "Grottos"))),
    ...
    ("LH Deku Scrub Grotto Right",                                   ("GrottoNPC",    0xEF,  0x37, None,                        'Buy Bombs (5) for 35 Rupees',           ("Lake Hylia", "Deku Scrub", "Grottos"))),
    ...
    ("GV Deku Scrub Grotto Rear",                                    ("GrottoNPC",    0xF0,  0x39, None,                        'Buy Red Potion for 30 Rupees',          ("Gerudo Valley", "Gerudo", "Deku Scrub", "Grottos"))),
    ...
    ("Colossus Deku Scrub Grotto Rear",                              ("GrottoNPC",    0xFD,  0x39, None,                        'Buy Red Potion for 30 Rupees',          ("Desert Colossus", "Deku Scrub", "Grottos"))),
    ...
    ("Dodongos Cavern MQ Deku Scrub Side Room Near Lower Lizalfos",  ("NPC",          0x01,  0x39, None,                        'Buy Red Potion for 30 Rupees',          ("Dodongo's Cavern", "Master Quest", "Deku Scrub",))),
    ...
    ("Ganons Castle Deku Scrub Center-Left",                         ("NPC",          0x0D,  0x37, None,                        'Buy Bombs (5) for 35 Rupees',           ("Ganon's Castle", "Vanilla", "Deku Scrub",))),
    ("Ganons Castle Deku Scrub Center-Right",                        ("NPC",          0x0D,  0x33, None,                        'Buy Arrows (30)',                       ("Ganon's Castle", "Vanilla", "Deku Scrub",))),
    ("Ganons Castle Deku Scrub Right",                               ("NPC",          0x0D,  0x39, None,                        'Buy Red Potion for 30 Rupees',          ("Ganon's Castle", "Vanilla", "Deku Scrub",))),
    # Ganon's Castle MQ
    ...
    ("Ganons Castle MQ Deku Scrub Center-Left",                      ("NPC",          0x0D,  0x37, None,                        'Buy Bombs (5) for 35 Rupees',           ("Ganon's Castle", "Master Quest", "Deku Scrub",))),
    ("Ganons Castle MQ Deku Scrub Center",                           ("NPC",          0x0D,  0x33, None,                        'Buy Arrows (30)',                       ("Ganon's Castle", "Master Quest", "Deku Scrub",))),
    ("Ganons Castle MQ Deku Scrub Center-Right",                     ("NPC",          0x0D,  0x39, None,                        'Buy Red Potion for 30 Rupees',          ("Ganon's Castle", "Master Quest", "Deku Scrub",))),
