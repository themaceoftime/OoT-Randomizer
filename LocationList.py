...
location_table = OrderedDict([
    ...
    # Thieves' Hideout
    ("Hideout Jail Guard (1 Torch)",                    ("Collectable", 0x0C,  0x0C, None,                     ("Thieves' Hideout", "Gerudo",))),
    ("Hideout Jail Guard (2 Torches)",                  ("Collectable", 0x0C,  0x0F, None,                     ("Thieves' Hideout", "Gerudo",))),
    ("Hideout Jail Guard (3 Torches)",                  ("Collectable", 0x0C,  0x0A, None,                     ("Thieves' Hideout", "Gerudo",))),
    ("Hideout Jail Guard (4 Torches)",                  ("Collectable", 0x0C,  0x0E, None,                     ("Thieves' Hideout", "Gerudo",))),
