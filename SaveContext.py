...
class SaveContext():
            ...
            if item.startswith('Silver Rupee ('):
                ...
                if count >= needed_count:
                    save_writes = {
                        ...
                        "Ice Cavern Spinning Blade":          {'silver_rupee_counts.ice_scythe': needed_count, 'scene_flags.ice.swch.silver_rupees_scythe': True},
    ...
    save_writes_table = {
        ...
        'Silver Rupee (Ice Cavern Spinning Blade)':            {'silver_rupee_counts.ice_scythe': None},
