...
hintTable = {
    ...
    'Water Temple MQ Central Pillar Chest':                        ("in the #depths of the Water Temple# lies", "a chest in the #central pillar of Water Temple# contains", ['dungeon', 'sometimes']),
    ...
    'Ganons Castle MQ Shadow Trial Eye Switch Chest':              ("#light in the test of darkness# unveils", "shooting an #eye switch in the Shadow Trial# reveals", ['dungeon', 'sometimes']),
