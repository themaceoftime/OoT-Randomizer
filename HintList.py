...
hintTable = {
    ...
    'Boss Key (Forest Temple)':                                 (["a natural master of unlocking", "an overgrown dungeon's master pass"], "the Forest Temple Boss Key", 'item'),
    'Boss Key (Fire Temple)':                                   (["a torrid master of unlocking", "a hot dungeon's master pass"], "the Fire Temple Boss Key", 'item'),
    'Boss Key (Water Temple)':                                  (["a moist master of unlocking", "a wet dungeon's master pass"], "the Water Temple Boss Key", 'item'),
    'Boss Key (Shadow Temple)':                                 (["a gloomy master of unlocking", "a dark dungeon's master pass"], "the Shadow Temple Boss Key", 'item'),
    'Boss Key (Spirit Temple)':                                 (["a wise master of unlocking", "a paradoxical dungeon's master pass"], "the Spirit Temple Boss Key", 'item'),
    'Boss Key (Ganons Castle)':                                 (["an evil master of unlocking", "a floating dungeon's master pass"], "Ganon's Castle Boss Key", 'item'),
    'Small Key (Forest Temple)':                                (["a natural tool for unlocking", "an overgrown dungeon pass", "a wild lock remover", "a wild lockpick"], "a Forest Temple Small Key", 'item'),
    'Small Key (Fire Temple)':                                  (["a torrid tool for unlocking", "a hot dungeon pass", "a sizzling lock remover", "a sizzling lockpick"], "a Fire Temple Small Key", 'item'),
    'Small Key (Water Temple)':                                 (["a moist tool for unlocking", "a wet dungeon pass", "a soggy lock remover", "a soggy lockpick"], "a Water Temple Small Key", 'item'),
    'Small Key (Shadow Temple)':                                (["a gloomy tool for unlocking", "a dark dungeon pass", "a dusky lock remover", "a dusky lockpick"], "a Shadow Temple Small Key", 'item'),
    'Small Key (Spirit Temple)':                                (["a wise tool for unlocking", "a paradoxical dungeon pass", "a spunky lock remover", "a spunky lockpick"], "a Spirit Temple Small Key", 'item'),
    'Small Key (Bottom of the Well)':                           (["an abyssal tool for unlocking", "a deep dungeon pass", "a buried lock remover", "a buried lockpick"], "a Bottom of the Well Small Key", 'item'),
    'Small Key (Gerudo Training Ground)':                       (["a testing tool for unlocking", "a developmental dungeon pass", "a learning lock remover", "a learning lockpick"], "a Gerudo Training Ground Small Key", 'item'),
    'Small Key (Ganons Castle)':                                (["an evil tool for unlocking", "a floating dungeon pass", "a free trial lock remover", "a free trial lockpick"], "a Ganon's Castle Small Key", 'item'),
