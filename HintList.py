...
def getHintGroup(group, world):
    ...
    for name in hintTable:
        ...
        if world.shuffle_grotto_entrances:
            if name == 'HC GS Storms Grotto' or name == 'HF GS Cow Grotto':
                continue
...
hintTable = {
    ...
    'Ruto\'s Letter':                                           (["a call for help", "the note that Mweeps", "an SOS call", "a fishy stationery"], "Ruto's Letter", 'item'),
    ...
    'Sheik in Forest':                                          ("deep in #the forest# Sheik teaches", None, ['song', 'sometimes']),
    ...
    'HC GS Storms Grotto':                                      ("a #storm near the castle# reveals", None, ['overworld', 'sometimes']),
    ...
    'Jabu Jabus Belly Boomerang Chest':                         ("in the #belly of a deity#, a school of stingers guard", None, 'sometimes'),
    'Jabu Jabus Belly MQ GS Invisible Enemies Room':            ("in the #belly of a deity#, a spider surrounded by shadows holds", None, ['dungeon', 'sometimes']),
    ...
    'Fire Temple MQ Chest On Fire':                             ("high in the #Fire Temple#, Flare Dancers hid", None, ['dungeon', 'sometimes']),
    'Fire Temple MQ GS Above Fire Wall Maze':                   ("high in the #Fire Temple#, a spider holds", None, ['dungeon', 'sometimes']),
    ...
    'Water Temple MQ GS Freestanding Key Area':                 ("deep under #the lake#, the locked spider holds", None, ['dungeon', 'sometimes']),
    ...
    'Bottom of the Well Lens of Truth Chest':                   ("#Dead Hand# holds", "#Dead Hand# in the well holds", ['dungeon', 'sometimes']),
    ...
    'Spirit Temple MQ Child Hammer Switch Chest':               ("within #the Colossus# a temporal paradox yields", None, ['dungeon', 'sometimes']),
    'Spirit Temple MQ Symphony Room Chest':                     ("within #the Colossus# a symphony yields", None, ['dungeon', 'sometimes']),
    'Spirit Temple MQ GS Symphony Room':                        ("within #the Colossus# a spider's symphony yields", None, ['dungeon', 'sometimes']),
    'Shadow Temple Invisible Floormaster Chest':                (["shadows in an #invisible maze# guard", "after a free #boat ride# comes"], None, ['dungeon', 'sometimes']),
    ...
    'Gerudo Valley -> GV Octorok Grotto':                       ("on #a ledge in the valley#, a silver rock hides", None, 'entrance'),
    ...
    'Desert Colossus -> Colossus Great Fairy Fountain':         ("a fractured wall #in the desert# hides", None, 'entrance'),
    ...
    'GV Carpenter Tent':                                        ("Carpenters' tent", None, 'region'),
    'Market Guard House':                                       ("the #Guard House#", None, 'region'),
    'Market Mask Shop':                                         ("the #Happy Mask Shop#", None, 'region'),
    'Market Bombchu Bowling':                                   ("the #Bombchu Bowling#", None, 'region'),
