...
hintTable = {
    ...
    'Boss Key (Forest Temple)':                                 (["a master of unlocking for deep in a forest", "a master pass for deep in a forest"], "the Forest Temple Boss Key", 'item'),
    ...
    'Small Key (Forest Temple)':                                (["a tool for unlocking a deep forest", "a dungeon pass for deep in a forest", "a lock remover for deep in a forest", "a lockpick for deep in a forest"], "a Forest Temple Small Key", 'item'),
