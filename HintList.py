...
hintTable = {
    ...
    'Boss Key (Ganons Castle)':                                 (["an evil master of unlocking", "a floating dungeon's master pass"], "Ganons Castle Boss Key", 'item'),
    ...
    'Small Key (Ganons Castle)':                                (["an evil tool for unlocking", "a floating dungeon pass", "a free trial lock remover", "a free trial lockpick"], "a Ganons Castle Small Key", 'item'),
