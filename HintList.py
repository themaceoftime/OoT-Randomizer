...
hintTable = {
    ...
    'Deku Tree MQ GS Basement Graves Room':                     ("a #spider on the ceiling of a tree# holds", None, ['dungeon', 'sometimes']),
    'GS Dodongo\'s Cavern MQ Song of Time Block Room':          ("a spider under #temporal stones in a cavern# holds", None, ['dungeon', 'sometimes']),
    'Jabu Jabus Belly Boomerang Chest':                         ("a school of #stingers swallowed by a deity# guard", None, ['dungeon', 'sometimes']),
    'Jabu Jabus Belly MQ GS Invisible Enemies Room':            ("a spider surrounded by #shadows in the belly of a deity# holds", None, ['dungeon', 'sometimes']),
