...
hintTable = {
    ...
    'Hideout 1 Torch Jail Guard':                                  ("#defeating Gerudo guards# reveals", None, 'exclude'),
    'Hideout 2 Torches Jail Guard':                                ("#defeating Gerudo guards# reveals", None, 'exclude'),
    'Hideout 3 Torches Jail Guard':                                ("#defeating Gerudo guards# reveals", None, 'exclude'),
    'Hideout 4 Torches Jail Guard':                                ("#defeating Gerudo guards# reveals", None, 'exclude'),
