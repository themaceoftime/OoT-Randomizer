...
hintTable = {
    ...
    # Junk hints that satisfied one or more of the following conditions were discarded:
    # - They were inappropriate.
    # - They were absurdly long copy pastas.
    # - They were quotes or references that were just not funny when out-of-context.
    # To elaborate on this last point: we wanted the junk hints to be hints that 
    # everyone can understand and not just those who get the obscure references.
    # Zelda references were considered fair game.
    ...
    '1008':                                                     ("Remember when Ganon was a blue pig?^I remember.", None, 'junk'),
    ...
    '1026':                                                     ("I've heard Sploosh Kaboom is a tricky game.", None, 'junk'), # ref: Windwaker
    ...
    '1066':                                                     ("You're playing a Randomizer. I'm randomized!^${12 48 31}Here's a random number:  #4#.&Enjoy your Randomizer!", None, 'junk'), # sfx: get small item from chest
    ...
    '1081':                                                     ("No matter what happens...Do not give up, do not complain, and do NOT stay up all night playing!", None, 'junk'), # ref: Windwaker
    ...
    '1085':                                                     ("They say that the patrol paths of the castle guards have major security vulnerabilities.", None, 'junk'),
    ...
    '1114':                                                     ("Three things are certain: death, taxes, and forgetting a check.", None, 'junk'),
    '1115':                                                     ("Have you thought about going where the items are?^Just saying.", None, 'junk'),
    '1116':                                                     ("They say that the true reward is the friends we made along the way.", None, 'junk'),
    ...
    '1139':                                                     ("They say that Mido is easily confused by sick flips.", None, 'junk'),
    ...
    '1159':                                                     ("Twenty-three is number one!^And thirty-one is number two!", None, 'junk'),
    ...
    '1216':                                                     ("Master, there is a 0 percent chance that this hint is useful in any way.", None, 'junk'),
    ...
    '1225':                                                     ("${12 68 62}Keeeyaaaah!^What is this?! A Hylian?!", None, 'junk'), # sfx: Ruto screaming
    '1226':                                                     ("For you, the day you read this hint was the most important day of your life.^But for me, it was Tuesday.", None, 'junk'),
    ...
    '1230':                                                     ("Hi! I'm currently on an exchange program from Termina.^They say that East Clock Town is on the way of the hero.", None, 'junk'),
    ...
    '1233':                                                     ("When the moon hits Termina like a big pizza pie that's game over.", None, 'junk'),
    '1234':                                                     ("Ganondorf doesn't specialize in hiding items, nor keeping secrets for that matter.", None, 'junk'),
