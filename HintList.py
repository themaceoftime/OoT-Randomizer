...
hintTable = {
    ...
    'Graveyard Royal Family Tomb Contents':                        ("inside the #Royal Family Tomb#, darkness and Redeads guard...^", None, 'dual'),
    ...
    'Forest Temple Basement':                                      ("in the #lowest part of the Forest Temple#, a chest and a spider hold...^", None, 'dual'),
    'Fire Temple Lower Loop':                                      ("in the #lowest part of the Fire Temple#, the hammer locks...^", None, 'dual'),
    'Water Temple River Loop Chests':                              ("in the #Water Temple#, chests past a shadowy fight hold...^", None, 'dual'),
    'Water Temple River Checks':                                   ("at the #river of the Water Temple#,a spider and a chest hold...^", None, 'dual'),
    'Water Temple North Basement Checks':                          ("the #northern parts of the Water Temple# hold...^", None, 'dual'),
    'Water Temple MQ North Basement Checks':                       ("the #northern parts of the Water Temple# hold...^", None, 'dual'),
    'Water Temple MQ Lower Checks':                                ("the #lowest parts of the Water Temple# hold...^", None, 'dual'),
    'Spirit Temple Colossus Hands':                                ("#the Colossus# holds in the palm of her hands...^", None, 'dual'),
