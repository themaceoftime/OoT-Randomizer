...
hintTable = {
    ...
    'Small Key (Gerudo Training Ground)':                       (["a tool for unlocking", "a dungeon pass", "a lock remover", "a lockpick"], "a Ganons Castle Small Key", 'item'),
    'Small Key (Ganons Castle)':                                (["a tool for unlocking", "a dungeon pass", "a lock remover", "a lockpick"], "a Forest Temple Small Key", 'item'),
