...
hintTable = {
    ...
    'Boss Key (Forest Temple)':                                 (["a master of unlocking", "a dungeon's master pass"], "the Forest Temple Boss Key", 'item'),
    'Boss Key (Fire Temple)':                                   (["a master of unlocking", "a dungeon's master pass"], "the Fire Temple Boss Key", 'item'),
    'Boss Key (Water Temple)':                                  (["a master of unlocking", "a dungeon's master pass"], "the Water Temple Boss Key", 'item'),
    'Boss Key (Shadow Temple)':                                 (["a master of unlocking", "a dungeon's master pass"], "the Shadow Temple Boss Key", 'item'),
    'Boss Key (Spirit Temple)':                                 (["a master of unlocking", "a dungeon's master pass"], "the Spirit Temple Boss Key", 'item'),
    'Boss Key (Ganons Castle)':                                 (["a master of unlocking", "a dungeon's master pass"], "Ganons Castle Boss Key", 'item'),
    'Small Key (Forest Temple)':                                (["a tool for unlocking", "a dungeon pass", "a lock remover", "a lockpick"], "a Forest Temple Small Key", 'item'),
    'Small Key (Fire Temple)':                                  (["a tool for unlocking", "a dungeon pass", "a lock remover", "a lockpick"], "a Fire Temple Small Key", 'item'),
    'Small Key (Water Temple)':                                 (["a tool for unlocking", "a dungeon pass", "a lock remover", "a lockpick"], "a Water Temple Small Key", 'item'),
    'Small Key (Shadow Temple)':                                (["a tool for unlocking", "a dungeon pass", "a lock remover", "a lockpick"], "a Shadow Temple Small Key", 'item'),
    'Small Key (Spirit Temple)':                                (["a tool for unlocking", "a dungeon pass", "a lock remover", "a lockpick"], "a Spirit Temple Small Key", 'item'),
    'Small Key (Bottom of the Well)':                           (["a tool for unlocking", "a dungeon pass", "a lock remover", "a lockpick"], "a Bottom of the Well Small Key", 'item'),
    'Small Key (Gerudo Training Ground)':                       (["a tool for unlocking", "a dungeon pass", "a lock remover", "a lockpick"], "a Gerudo Training Ground Small Key", 'item'),
    'Small Key (Ganons Castle)':                                (["a tool for unlocking", "a dungeon pass", "a lock remover", "a lockpick"], "a Ganons Castle Small Key", 'item'),
