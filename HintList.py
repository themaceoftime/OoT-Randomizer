...
conditional_dual = {
    ...
    'Sarias Song Checks':                                       lambda world: world.settings.shuffle_song_items in ['song', 'dungeon'],
    'Haunted Wasteland Checks':                                 lambda world: world.settings.tokensanity in ['overworld', 'all'],
...
hintTable = {
    ...
    'LH Fishing Hole Rewards':                                     ("#catching a big fish# yields, as a child and an adult respectively...^", None, 'dual'),
    ...
    'Deku Tree MQ Basement GS':                                    ("in the #basement of the Great Deku Tree# two spiders hold...^", None, 'dual'),
    ...
    'Dodongos Cavern MQ Depths':                                   ("in the #back of Dodongo's Cavern# a spider and a ghost guard...^", None, 'dual'),
    'Forest Temple Basement':                                      ("in the #basement of the Forest Temple# a chest and a spider hold...^", None, 'dual'),
    ...
    'Spirit Temple Adult Lower':                                   ("#past a silver block in the Spirit Temple# chests contain...^", None, 'dual'),
    'Spirit Temple MQ Child Top':                                  ("#in the sun block room# in the Spirit Temple a chest and a spider hold respectively...^", None, 'dual'),
    'Spirit Temple MQ Symphony Room':                              ("#beyond the symphony room# in the Spirit Temple a chest and a spider hold...^", None, 'dual'),
    'Shadow Temple Upper Checks':                                  ("#before the Truth Spinner gap# in the Shadow Temple chests contain...^", None, 'dual'),
    ...
    'Shadow Temple MQ Upper Checks':                               ("#before the Truth Spinner gap# in the Shadow Temple chests contain...^", None, 'dual'),
