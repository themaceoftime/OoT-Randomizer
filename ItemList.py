...
item_table = {
    ...
    'Small Key Ring (Forest Temple)':                  ('SmallKey', True,  0xCB, {'progressive': float('Inf')}),
    'Small Key Ring (Fire Temple)':                    ('SmallKey', True,  0xCC, {'progressive': float('Inf')}),
    'Small Key Ring (Water Temple)':                   ('SmallKey', True,  0xCD, {'progressive': float('Inf')}),
    'Small Key Ring (Spirit Temple)':                  ('SmallKey', True,  0xCE, {'progressive': float('Inf')}),
    'Small Key Ring (Shadow Temple)':                  ('SmallKey', True,  0xCF, {'progressive': float('Inf')}),
    'Small Key Ring (Bottom of the Well)':             ('SmallKey', True,  0xD0, {'progressive': float('Inf')}),
    'Small Key Ring (Gerudo Training Ground)':         ('SmallKey', True,  0xD1, {'progressive': float('Inf')}),
    'Small Key Ring (Thieves Hideout)':                ('HideoutSmallKey',True, 0xD2, {'progressive': float('Inf')}),
    'Small Key Ring (Ganons Castle)':                  ('SmallKey', True,  0xD3, {'progressive': float('Inf')}),
