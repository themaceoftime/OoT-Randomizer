...
item_table = {
    ...
    'Silver Rupee (Ice Cavern Spinning Blade)':                 ('SilverRupee', True,  0xD5, {'progressive': 5}),
    ...
    'Silver Rupee Pouch (Ice Cavern Spinning Blade)':           ('SilverRupee', True,  0xEB, {'alias': ('Silver Rupee (Ice Cavern Spinning Scythe)', 10), 'progressive': 1}),
