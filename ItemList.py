...
item_table = {
    ...
    'Small Key Pack (Forest Temple)':                  ('SmallKey', True,  0xCB, {'progressive': float('Inf')}),
    'Small Key Pack (Fire Temple)':                    ('SmallKey', True,  0xCC, {'progressive': float('Inf')}),
    'Small Key Pack (Water Temple)':                   ('SmallKey', True,  0xCD, {'progressive': float('Inf')}),
    'Small Key Pack (Spirit Temple)':                  ('SmallKey', True,  0xCE, {'progressive': float('Inf')}),
    'Small Key Pack (Shadow Temple)':                  ('SmallKey', True,  0xCF, {'progressive': float('Inf')}),
    'Small Key Pack (Bottom of the Well)':             ('SmallKey', True,  0xD0, {'progressive': float('Inf')}),
    'Small Key Pack (Gerudo Training Ground)':         ('SmallKey', True,  0xD1, {'progressive': float('Inf')}),
    'Small Key Pack (Thieves Hideout)':                ('HideoutSmallKey',True, 0xD2, {'progressive': float('Inf')}),
    'Small Key Pack (Ganons Castle)':                  ('SmallKey', True,  0xD3, {'progressive': float('Inf')}),
