...
def patch_rom(spoiler:Spoiler, world:World, rom:Rom):
    ...
    if world.settings.correct_chest_appearances == 'sizes' or world.settings.correct_chest_appearances == 'both':
        if not world.dungeon_mq['Ganons Castle']:
            ...
            if item['chest_type'] in (GOLD_CHEST, GILDED_CHEST, SKULL_CHEST_BIG, GOLD_CHEST_SMALL):
