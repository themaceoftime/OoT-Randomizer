...
def get_pool_core(world):
    ...
    if world.settings.item_pool_value == 'plentiful':
        ...
        if world.settings.shuffle_smallkeys in ['any_dungeon', 'overworld', 'keysanity', 'hint_color']:
        ...
        if world.settings.shuffle_bosskeys in ['any_dungeon', 'overworld', 'keysanity', 'hint_color']:
            for dungeon in ['Forest Temple', 'Fire Temple', 'Water Temple', 'Shadow Temple', 'Spirit Temple']:
                pending_junk_pool.append(f"Boss Key ({dungeon})")
        if world.settings.shuffle_ganon_bosskey in ['any_dungeon', 'overworld', 'keysanity', 'hint_color']:
        ...
        # Dungeon Items
            ...
            if shuffle_setting is not None and not shuffle_item:
                ...
                if shuffle_setting in ['remove', 'startwith', 'triforce']:
                    ...
                    item = get_junk_item()[0]
                    shuffle_item = True
                elif shuffle_setting in ['any_dungeon', 'overworld', 'hint_color']:
